...
sumoCmd = ["sumo", "-c", "/home/akashs/codes/13-06-24/cubbon1.sumocfg"]  # Update this path as necessary
...
while traci.simulation.getMinExpectedNumber() > 0:
    ...
    if step > 0 and step % 60 == 0:  # Every 60 steps (1 minute)
...
csv_path = "cubbon_park_1D_train.csv"  # Adjust path as needed
